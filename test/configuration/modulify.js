...
tests.push(new TestNode('(no args)', [{}], true))
	...
	.Exists('koaton_module_package', 'testingapp', 'public', 'img', 'koaton.png')
	.Exists('koaton_module_package', 'testingapp', 'public', 'img', 'koaton-simple.png')
	...
	.Exists('koaton_module_package', 'testingapp', 'views', 'layouts', 'testingapp.main.handlebars')
